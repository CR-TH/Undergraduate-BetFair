...
public class GameRecorder extends TimerTask implements Observable
{
	...
	{
		//Flow of execution is pass new data to get, get probabilities from io + closed markets, check if over then notify
	...
	{
		//Flow of execution is get new data, pass new data to get, get probabilities from io + closed markets,
